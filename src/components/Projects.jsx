...
const projects = [
  {
    ...
    desc: 'Built and scaled the technical backbone of a micro-drama streaming platform powering Digital Kalakaar. HLS adaptive streaming, high-traffic burst handling, creator tooling.',
  ...
  },
  {
    num: '03',
    name: 'ACCESSWAY',
    tagline: 'AR Navigation for Disabilities',
    desc: 'Smart AR navigation for people with visual and mobility impairments. Moved beyond prototype into real-world deployment.',
    impact: 'Real-World Deployment',
    stack: ['AR', 'React Native', 'Node.js', 'Computer Vision'],
    org: 'Competition Origin',
    bg: '#EDE6D3',
    link: null,
  },
  {
    num: '04',
    name: 'LOGIGREEN',
    tagline: 'AI Logistics · Eco-Routing · AR',
    desc: 'AI-powered logistics with eco-routing optimization and AR packaging visualization. Reduces carbon footprint while improving operational efficiency.',
    impact: 'Eco-Optimized · AI Routing',
    stack: ['AI/ML', 'Node.js', 'AR', 'Python'],
