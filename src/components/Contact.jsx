...
<h2 className="text-4xl md:text-6xl font-extrabold leading-tight text-center text-black dark:text-white mb-4 font-sans">
  LET’S WORK <br />
  <span className="text-gray-600 dark:text-gray-500">TOGETHER</span>
</h2>
