    ...
    >
      ...
      <div className="hero-main" style={{ position: 'relative', zIndex: 10 }}>
        ...
        <div className="hero-left">
          ...
          >
            {[
              '20 years old. Still in college. Already shipped.',
              'Built for governments. Scaled for a 15M+ follower production house.',
              'Started with Scratch games at 13. Never stopped building.',
            ].map((line, i) => (
              <motion.p
                key={i}
                initial={{ opacity: 0, x: -12 }}
                animate={{ opacity: 1, x: 0 }}
                transition={{ duration: 0.5, delay: 0.88 + i * 0.1, ease: [0.16, 1, 0.3, 1] }}
                style={{
                  fontFamily: 'Space Grotesk, sans-serif',
                  fontSize: i === 0 ? '0.88rem' : '0.78rem',
                  fontWeight: i === 0 ? '700' : '500',
                  color: i === 0 ? '#1A1A1A' : '#3D2B1F',
                  opacity: i === 0 ? 1 : 0.65,
                  margin: '0 0 4px',
                  lineHeight: '1.5',
                }}
